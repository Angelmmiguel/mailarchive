...
folder (browsers with folder access only), rebuild the index from the originals,
list the blobs nothing points to for the server admin to remove, the theme for this device (system
