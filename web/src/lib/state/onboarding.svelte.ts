 ...
 * exists only here between Create account and Recovery key: it is shown
 * once and forgotten as soon as the user confirms it is stored. A reload
 * loses it, which is the case Recovery key has to handle.
 */
class Onboarding {
